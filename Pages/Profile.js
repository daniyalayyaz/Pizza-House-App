        ...
        <SafeAreaView style={{ paddingTop: Platform.OS === 'android' ? 40 : 0 }}>
            <View style={{ display: 'flex', flexDirection: 'column', height: height, justifyContent: 'space-between', backgroundColor: 'white', overflow: 'hidden' }}>
                <Card style={{
                    ...
                    <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: 20, height: height / 3.8 }}>
                        <Image source={require('../assets/pizzahouse.png')} style={{ height: height / 4, width: width / 2 }}></Image>
                ...
                <List.Item
                    title={idx.title}
                    left={props => <List.Icon {...props} icon={idx.icon} color='#50ac4c' />}
                />
            </TouchableOpacity>
                ))}
        </View>
