            ...
            <SafeAreaView style={{ paddingTop: Platform.OS === 'android' ? 40 : 0 }}>
                <View style={{ display: 'flex', flexDirection: 'column', height: height, backgroundColor: 'white', overflow: 'hidden' }}>
                            ...
                            <Card style={{
                                ...
                                <RadioButton.Group onValueChange={newValue => setValue(newValue)} value={value}>
                                    <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', paddingTop: 10 }}>
                                        <RadioButton value="delivery" color='#f01c24' />
                                        <Text>Delivery</Text>

                                    </View>
                                    <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', paddingTop: 10 }}>
                                        <RadioButton value="collection" color='#f01c24' />
                                ...
                                <Button
                                    style={{ marginBottom: 20, backgroundColor: "#f01c24", marginTop: 10 }}
                        ...
                        <View style={{ paddingRight: 20, paddingLeft: 20, paddingBottom: 20 }}>
                            <Card style={{
                                ...
                                <RadioButton.Group onValueChange={newValue => setVal(newValue)} value={val}>
                                    <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', paddingTop: 10 }}>
                                        <RadioButton value="COD" color='#f01c24' />
                                        <Text>Cash on delivery</Text>

                                    </View>
                                    <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', paddingTop: 10 }}>
                                        <RadioButton value="PWD" color='#f01c24' />
                        ...
                        <View style={{ paddingRight: 20, paddingLeft: 20, paddingBottom: 20 }}>
                            <Card style={{
                                ...
                                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', paddingTop: 20 }}>
                                    <Text style={{ fontSize: 14, fontWeight: 'bold', marginBottom: 5, color: '#f01c24' }}>SUBTOTAL</Text>
                                    <Text style={{ fontSize: 14, fontWeight: 'bold', marginBottom: 5 }}>$40</Text>
                                </View>
                                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', paddingTop: 20 }}>
                                    <Text style={{ fontSize: 14, fontWeight: 'bold', marginBottom: 5, color: '#f01c24' }}>DISCOUNT</Text>
                                    <Text style={{ fontSize: 14, fontWeight: 'bold', marginBottom: 5 }}>$0</Text>
                                </View>
                                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', paddingTop: 20 }}>
                                    <Text style={{ fontSize: 14, fontWeight: 'bold', marginBottom: 5, color: '#f01c24' }}>TOTAL</Text>
                                    <Text style={{ fontSize: 14, fontWeight: 'bold', marginBottom: 5 }}>$40</Text>
                                </View>
                    ...
                    <View style={{ paddingLeft: 20, paddingRight: 20 }}>
                        <Button
                            style={{ marginBottom: 20, backgroundColor: "#f01c24", marginTop: 20 }}
                            mode="contained"
